    ...
    <section className="mt-4">
      ...
      <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
        {movies.map((movie) => (
          <div
            key={movie.id}
            className="group relative shrink-0 w-32 cursor-pointer"
          ...
          >
            ...
            <p className="mt-2 font-body text-xs font-medium truncate text-muted-foreground group-hover:text-foreground transition-colors">
              {movie.title}
            </p>
          </div>
        ))}
